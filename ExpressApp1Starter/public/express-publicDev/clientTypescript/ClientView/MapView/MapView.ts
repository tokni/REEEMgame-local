...
export class MapView {
    ...
    public updateBrowser = (p_data, p_pathway_name, p_var_name?) => {
        var i = 0;
        for (var e of p_data) {
        ...
        this.m_map.updateCurrentLayer(p_data[p_data.length - 2], p_pathway_name, p_data[p_data.length - 1], p_var_name);
    }
}